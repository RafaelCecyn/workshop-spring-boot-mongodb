package com.rafaelcecyn.workshopmongo.config;
...
import com.rafaelcecyn.workshopmongo.dto.AuthorDTO;
import com.rafaelcecyn.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userRepository.deleteAll(); // Deleta todos os dados prévios
